              ...
              <li className="mb-12">
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    ...
                    <a className="font-bold text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" href="https://github.com/liannfinlayson26/product-discovery-engine" target="_blank" rel="noreferrer noopener" aria-label="View source on GitHub (opens in a new tab)">View source on GitHub &rarr;</a>
                    </p>
