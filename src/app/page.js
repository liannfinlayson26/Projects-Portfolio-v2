            ...
            <ul className="group/list">
              <li className="mb-12">
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    <h3>
                      <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base" href="https://product-discovery-engine.vercel.app" target="_blank" rel="noreferrer noopener" aria-label="Product Discovery Engine (opens in a new tab)">
                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                        <span>Product Discovery Engine
                    ...
                    An agentic AI app that lets you photograph any product and instantly find where to buy it online. I built it with Claude Code, orchestrating Google&apos;s Gemini Vision to identify the item &mdash; its name, brand, category, and style &mdash; and the Tavily web search API to surface real purchase links with prices and store thumbnails. Each search is saved to a local history for quick re-viewing.
                    </p>
                    <a className="relative z-10 mt-3 inline-flex items-center text-sm font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" href="https://github.com/liannfinlayson26/product-discovery-engine" target="_blank" rel="noreferrer noopener" aria-label="Product Discovery Engine source code on GitHub (opens in a new tab)">
                      <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" className="mr-1.5 h-4 w-4">
                    ...
                    <ul className="mt-2 flex flex-wrap" aria-label="Technologies used:">
                      ...
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Gemini Vision</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Tavily</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                      ...
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Claude Code</div>
                      </li>
                    </ul>
                  </div>
                  <img alt="Product Discovery Engine"
                       loading="lazy"
                       width="200"
                       height="48"
                       decoding="async"
                       ...
                       src="/product-discovery-engine.png"
              ...
              <li className="mb-12">
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    <h3>
                      <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base" href="https://github.com/liannfinlayson26/multi-agent-workflows/blob/main/multi_agent_workflows.ipynb" target="_blank" rel="noreferrer noopener" aria-label="Multi-Agent Campaign Studio (opens in a new tab)">
                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                        <span>Multi-Agent Campaign Studio
                          <span className="inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-1 translate-y-px" aria-hidden="true">
                              <path fillRule="evenodd" d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clipRule="evenodd"></path>
                            </svg>
                    ...
                    <p className="mt-2 text-sm leading-normal">
                    A multi-agent marketing pipeline I built on the OpenAI Agents SDK. A one-line brief flows through three specialized agents &mdash; a Creative Director that researches the market with a custom Tavily web-search tool and generates campaign ideas, a Strategist that picks the strongest two, and a Copywriter that drafts the final promotional tweets. The agents exchange typed Pydantic objects and share memory through a single session.{" "}
                    <a className="relative z-10 font-bold text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" href="https://github.com/liannfinlayson26/multi-agent-workflows" target="_blank" rel="noreferrer noopener" aria-label="View the repo on GitHub (opens in a new tab)">View the repo on GitHub &rarr;</a>
                    </p>
                    <ul className="mt-2 flex flex-wrap" aria-label="Technologies used:">
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">OpenAI Agents SDK</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                      ...
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Pydantic</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Tavily</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Multi-Agent Systems</div>
                      </li>
                    </ul>
                  </div>
                  <img alt="Multi-Agent Campaign Studio"
                       loading="lazy"
                       width="200"
                       height="48"
                       decoding="async"
